...
/// the assembly.
MCStreamer*
createAsmStreamer(MCContext& Ctx, std::unique_ptr<formatted_raw_ostream> OS, bool isVerboseAsm, bool useDwarfDirectory, MCInstPrinter* InstPrint, std::unique_ptr<MCCodeEmitter>&& CE, std::unique_ptr<MCAsmBackend>&& TAB, bool ShowInst);
...
struct Target {
    ...
    using ELFStreamerCtorTy =
        MCStreamer* (*)(const Triple& T, MCContext& Ctx, std::unique_ptr<MCAsmBackend>&& TAB, std::unique_ptr<MCObjectWriter>&& OW, std::unique_ptr<MCCodeEmitter>&& Emitter, bool RelaxAll);
    using MachOStreamerCtorTy =
        MCStreamer* (*)(MCContext& Ctx, std::unique_ptr<MCAsmBackend>&& TAB, std::unique_ptr<MCObjectWriter>&& OW, std::unique_ptr<MCCodeEmitter>&& Emitter, bool RelaxAll, bool DWARFMustBeAtTheEnd);
    using COFFStreamerCtorTy =
        MCStreamer* (*)(MCContext& Ctx, std::unique_ptr<MCAsmBackend>&& TAB, std::unique_ptr<MCObjectWriter>&& OW, std::unique_ptr<MCCodeEmitter>&& Emitter, bool RelaxAll, bool IncrementalLinkerCompatible);
    ...
    using CustomBehaviourCtorTy =
        mca::CustomBehaviour* (*)(const MCSubtargetInfo& STI, const mca::SourceMgr& SrcMgr, const MCInstrInfo& MCII);

    using InstrPostProcessCtorTy =
        mca::InstrPostProcess* (*)(const MCSubtargetInfo& STI, const MCInstrInfo& MCII);
...
struct TargetRegistry {
    ...
    static void
    RegisterMCAsmInfo(Target& T, Target::MCAsmInfoCtorFnTy Fn) {
    ...
    static void
    RegisterMCObjectFileInfo(Target& T, Target::MCObjectFileInfoCtorFnTy Fn) {
    ...
    static void
    RegisterMCInstrInfo(Target& T, Target::MCInstrInfoCtorFnTy Fn) {
    ...
    /// the given target.
    static void
    RegisterMCInstrAnalysis(Target& T, Target::MCInstrAnalysisCtorFnTy Fn) {
    ...
    static void
    RegisterMCRegInfo(Target& T, Target::MCRegInfoCtorFnTy Fn) {
    ...
    static void
    RegisterMCSubtargetInfo(Target& T, Target::MCSubtargetInfoCtorFnTy Fn) {
    ...
    static void
    RegisterTargetMachine(Target& T, Target::TargetMachineCtorTy Fn) {
    ...
    static void
    RegisterMCAsmBackend(Target& T, Target::MCAsmBackendCtorTy Fn) {
    ...
    static void
    RegisterMCAsmParser(Target& T, Target::MCAsmParserCtorTy Fn) {
    ...
    static void
    RegisterAsmPrinter(Target& T, Target::AsmPrinterCtorTy Fn) {
    ...
    static void
    RegisterMCDisassembler(Target& T, Target::MCDisassemblerCtorTy Fn) {
    ...
    static void
    RegisterMCInstPrinter(Target& T, Target::MCInstPrinterCtorTy Fn) {
    ...
    static void
    RegisterMCCodeEmitter(Target& T, Target::MCCodeEmitterCtorTy Fn) {
        T.MCCodeEmitterCtorFn = Fn;
    }

    static void
    RegisterCOFFStreamer(Target& T, Target::COFFStreamerCtorTy Fn) {
        T.COFFStreamerCtorFn = Fn;
    }

    static void
    RegisterMachOStreamer(Target& T, Target::MachOStreamerCtorTy Fn) {
        T.MachOStreamerCtorFn = Fn;
    }

    static void
    RegisterELFStreamer(Target& T, Target::ELFStreamerCtorTy Fn) {
        T.ELFStreamerCtorFn = Fn;
    }

    static void
    RegisterSPIRVStreamer(Target& T, Target::SPIRVStreamerCtorTy Fn) {
    ...
    static void
    RegisterWasmStreamer(Target& T, Target::WasmStreamerCtorTy Fn) {
        T.WasmStreamerCtorFn = Fn;
    }

    static void
    RegisterXCOFFStreamer(Target& T, Target::XCOFFStreamerCtorTy Fn) {
    ...
    static void
    RegisterAsmTargetStreamer(Target& T, Target::AsmTargetStreamerCtorTy Fn) {
        T.AsmTargetStreamerCtorFn = Fn;
    }

    static void
    RegisterObjectTargetStreamer(Target& T, Target::ObjectTargetStreamerCtorTy Fn) {
    ...
    static void
    RegisterMCRelocationInfo(Target& T, Target::MCRelocationInfoCtorTy Fn) {
    ...
    static void
    RegisterMCSymbolizer(Target& T, Target::MCSymbolizerCtorTy Fn) {
    ...
    static void
    RegisterCustomBehaviour(Target& T, Target::CustomBehaviourCtorTy Fn) {
    ...
    static void
    RegisterInstrPostProcess(Target& T, Target::InstrPostProcessCtorTy Fn) {
    ...
    /// target.
    static void
    RegisterInstrumentManager(Target& T, Target::InstrumentManagerCtorTy Fn) {
...
struct RegisterMCAsmInfo {
  ...
  private:
    static MCAsmInfo*
    Allocator(const MCRegisterInfo& /*MRI*/, const Triple& TT, const MCTargetOptions& Options) {
...
struct RegisterMCObjectFileInfo {
  ...
  private:
    ...
    Allocator(MCContext& Ctx, bool PIC, bool LargeCodeModel = false) {
...
struct RegisterMCInstrAnalysis {
  ...
  private:
    ...
    Allocator(const MCInstrInfo* Info) {
...
struct RegisterMCSubtargetInfo {
  ...
  private:
    ...
    Allocator(const Triple& /*TT*/, StringRef /*CPU*/, StringRef /*FS*/) {
...
struct RegisterTargetMachine {
  ...
  private:
    ...
    Allocator(const Target& T, const Triple& TT, StringRef CPU, StringRef FS, const TargetOptions& Options, std::optional<Reloc::Model> RM, std::optional<CodeModel::Model> CM, CodeGenOpt::Level OL, bool JIT) {
...
struct RegisterMCAsmBackend {
  ...
  private:
    static MCAsmBackend*
    Allocator(const Target& T, const MCSubtargetInfo& STI, const MCRegisterInfo& MRI, const MCTargetOptions& Options) {
...
struct RegisterMCAsmParser {
  ...
  private:
    ...
    Allocator(const MCSubtargetInfo& STI, MCAsmParser& P, const MCInstrInfo& MII, const MCTargetOptions& Options) {
...
struct RegisterMCCodeEmitter {
  ...
  private:
    ...
    Allocator(const MCInstrInfo& /*II*/, MCContext& /*Ctx*/) {
