...
#include "llvm_include_llvm_TargetParser_AArch64TargetParser.h"
#include "llvm_include_llvm_ADT_StringSwitch.h"
#include "llvm_include_llvm_TargetParser_ARMTargetParserCommon.h"
...
#define AARCH64_CPU_NAME(NAME, ID, DEFAULT_EXT)                                \
  .Case(NAME, AArch64ARCHNames[static_cast<unsigned>(ArchKind::ID)]            \
                      .ArchBaseExtensions |                                    \
                  DEFAULT_EXT)
#include "llvm_lib_TargetParser_.._.._include_llvm_TargetParser_AArch64TargetParser.def"
