...
#include "llvm_include_llvm_Object_ELF.h"
...
StringRef llvm::object::getELFRelocationTypeName(uint32_t Machine,
  ...
  case ELF::EM_68K:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_M68k.def"
    default:
      break;
    }
    break;
  case ELF::EM_X86_64:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_x86_64.def"
    default:
      break;
    }
    break;
  ...
  case ELF::EM_IAMCU:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_i386.def"
    default:
      break;
    }
    break;
  case ELF::EM_MIPS:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_Mips.def"
    default:
      break;
    }
    break;
  case ELF::EM_AARCH64:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_AArch64.def"
    default:
      break;
    }
    break;
  case ELF::EM_ARM:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_ARM.def"
    default:
      break;
    }
    break;
  ...
  case ELF::EM_ARC_COMPACT2:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_ARC.def"
    default:
      break;
    }
    break;
  case ELF::EM_AVR:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_AVR.def"
    default:
      break;
    }
    break;
  case ELF::EM_HEXAGON:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_Hexagon.def"
    default:
      break;
    }
    break;
  case ELF::EM_LANAI:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_Lanai.def"
    default:
      break;
    }
    break;
  case ELF::EM_PPC:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_PowerPC.def"
    default:
      break;
    }
    break;
  case ELF::EM_PPC64:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_PowerPC64.def"
    default:
      break;
    }
    break;
  case ELF::EM_RISCV:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_RISCV.def"
    default:
      break;
    }
    break;
  case ELF::EM_S390:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_SystemZ.def"
    default:
      break;
    }
    break;
  ...
  case ELF::EM_SPARCV9:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_Sparc.def"
    default:
      break;
    }
    break;
  case ELF::EM_AMDGPU:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_AMDGPU.def"
    default:
      break;
    }
    break;
  case ELF::EM_BPF:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_BPF.def"
    default:
      break;
    }
    break;
  case ELF::EM_MSP430:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_MSP430.def"
    default:
      break;
    }
    break;
  case ELF::EM_VE:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_VE.def"
    default:
      break;
    }
    break;
  case ELF::EM_CSKY:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_CSKY.def"
    default:
      break;
    }
    break;
  case ELF::EM_LOONGARCH:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_LoongArch.def"
    default:
      break;
    }
    break;
  case ELF::EM_XTENSA:
    switch (Type) {
#include "llvm_include_llvm_BinaryFormat_ELFRelocs_Xtensa.def"
    default:
      break;
    }
    break;
...
#include "llvm_include_llvm_BinaryFormat_DynamicTags.def"
