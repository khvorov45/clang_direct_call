...
#include "llvm_include_llvm_Transforms_IPO_FunctionSpecialization.h"
...
#include "llvm_include_llvm_Analysis_ValueLattice.h"
#include "llvm_include_llvm_Analysis_ValueLatticeUtils.h"
