...
#include "llvm_include_llvm_IR_Assumptions.h"
...
#include "clang_include_clang_Basic_arm_mve_builtin_aliases.inc"
...
#include "clang_include_clang_Basic_arm_cde_builtin_aliases.inc"
  return ArmBuiltinAliasValid(BuiltinID, AliasName, Map, IntrinNames);
}
