...
#include "clang_include_clang_Basic_BuiltinsNEON.def"
    FirstTSBuiltin
  };
  }
...
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsARM.def"
      LastTSBuiltin
    };
  }
  ...
  enum {
    LastNEONBuiltin = NEON::FirstTSBuiltin - 1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsSVE.def"
    FirstTSBuiltin,
  };
  }
  ...
  #define BUILTIN(ID, TYPE, ATTRS) BI##ID,
  #include "clang_include_clang_Basic_BuiltinsAArch64.def"
    LastTSBuiltin
  };
  }
...
#include "clang_include_clang_Basic_BuiltinsPPC.def"
  ...
  namespace NVPTX {
    enum {
        LastTIBuiltin = clang::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsNVPTX.def"
        LastTSBuiltin
    };
  }
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
  #define BUILTIN(ID, TYPE, ATTRS) BI##ID,
  #include "clang_include_clang_Basic_BuiltinsAMDGPU.def"
    LastTSBuiltin
  };
  }
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsX86.def"
    FirstX86_64Builtin,
    LastX86CommonBuiltin = FirstX86_64Builtin - 1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsX86_64.def"
    LastTSBuiltin
  };
  }
...
#include "clang_include_clang_Basic_BuiltinsVE.def"
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsRISCVVector.def"
    FirstTSBuiltin,
  };
  }
...
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsRISCV.def"
    LastTSBuiltin
  };
  } // namespace RISCV
  ...
  enum {
    LastTIBuiltin = clang::Builtin::FirstTSBuiltin - 1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsLoongArch.def"
    LastTSBuiltin
  };
  } // namespace LoongArch
...
#include "clang_include_clang_Basic_arm_sve_typeflags.inc"
...
#undef LLVM_GET_SVE_IMMCHECKTYPES
  ...
  namespace Hexagon {
    enum {
        LastTIBuiltin = clang::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsHexagon.def"
        LastTSBuiltin
    };
  }
  ...
  namespace Mips {
    enum {
        LastTIBuiltin = clang::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsMips.def"
        LastTSBuiltin
    };
  }
  ...
  namespace XCore {
    enum {
        LastTIBuiltin = clang::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsXCore.def"
        LastTSBuiltin
    };
  }
  ...
  namespace SystemZ {
    enum {
        LastTIBuiltin = clang::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsSystemZ.def"
        LastTSBuiltin
    };
  }
  ...
  namespace WebAssembly {
    enum {
      LastTIBuiltin = clang::Builtin::FirstTSBuiltin-1,
#define BUILTIN(ID, TYPE, ATTRS) BI##ID,
#include "clang_include_clang_Basic_BuiltinsWebAssembly.def"
      LastTSBuiltin
    };
  }
