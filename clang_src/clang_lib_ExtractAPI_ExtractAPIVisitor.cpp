...
#include "clang_lib_ExtractAPI_TypedefUnderlyingTypeResolver.h"
...
#include "clang_include_clang_ExtractAPI_AvailabilityInfo.h"
#include "clang_include_clang_ExtractAPI_DeclarationFragments.h"
